...
class HttpPrioritizedTest {
    ...
    public void shouldBeGetHistory() throws IOException, InterruptedException, NotFoundException {
        ...
        Subtask subtask3 = new Subtask("Подзадача 3", "Подзадача 3, Эпик 1", TaskState.NEW, LocalDateTime.parse("05.01.2024 11:00", dateTimeFormatter), Duration.ofMinutes(30L), addedEpic1.getId());
        ...
        assertEquals("Подзадача 3", prioritizedTasks.get(0).getName(), "Некорректное количество задач в истории");
    }
}